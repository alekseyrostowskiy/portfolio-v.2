...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold"> Привет, меня зовут Алексей.</span> <br />Я
        {" "}
        <span className="font-bold">начинающий full-stack разработчик.</span>{" "}<br/>
        Мне нравится создавать
        <span className="italic">
          {" "}
          сайты и приложения различной сложности.{" "}
        </span>
        <br />
        Пишу код на{" "}
